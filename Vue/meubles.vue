            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						...
						<div class="mb-3"><label for="type" class="form-label">type</label><input type="text" class="form-control" id="type" v-model="type"></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form @submit.prevent="submitForm">
						...
						<div class="mb-3"><label for="type" class="form-label">type</label><input type="text" class="form-control" id="type" v-model="selectedItem.type"></div>
...
export default {
    ...
    methods: {
        async findAll() {
            try {
                const response = await fetch('http://localhost:5289/meubles');
                if (!response.ok) {
        ...
        async updateElement() {
            try {
                const response = await fetch(`http://localhost:5289/meubles/${this.selectedItem.id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async deleteElement(id) {
            try {
                const response = await fetch(`http://localhost:5289/meubles/${id}`, {
                    method: 'DELETE'
                });
                if (!response.ok) {
